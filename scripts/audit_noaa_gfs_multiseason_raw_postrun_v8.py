#!/usr/bin/env python
"""Offline, read-only V8 postrun audit for the frozen Track A raw producer.
...
V8 is an append-only source fork of the frozen V7 auditor.  The transaction,
raw, decoded and full offline replay audit remains unchanged.  V8 supersedes
only V7's immutable-recovery pytest-duration suffix false reject: the exact V2
preflight evidence is validated before every Parquet/data/replay route with a
strict integer-hundredths parser for pytest's redundant timedelta suffix.
"""
...
AUDITOR_TEST = REPO / "tests" / "test_noaa_gfs_multiseason_raw_postrun_v8.py"
...
FROZEN_V7_AUDITOR = REPO / "scripts" / "audit_noaa_gfs_multiseason_raw_postrun_v7.py"
FROZEN_V7_AUDITOR_TEST = REPO / "tests" / "test_noaa_gfs_multiseason_raw_postrun_v7.py"
FROZEN_V7_SEALER = V7_SEALER
FROZEN_V7_SEALER_TEST = V7_SEALER_TEST
V8_AUTH_RELATIVE = "prereg/decode_recovery_postrun_audit_authorization_v8.json"
V8_REVIEW_RELATIVE = (
    "independent_redteam/TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_REVIEW_V8.json"
)
V8_GO_RELATIVE = (
    "independent_redteam/TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_GO_V8.json"
)
V8_SEALER = REPO / "scripts" / "seal_noaa_gfs_multiseason_postrun_audit_v8.py"
V8_SEALER_TEST = REPO / "tests" / "test_seal_noaa_gfs_multiseason_postrun_audit_v8.py"
...
V8_POSTRUN_REPORT_CANDIDATES = tuple(
    relative
...
V8_DURATION_SUFFIX_INCIDENT_RELATIVE = (
    "incidents/"
    "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_V7_IMMUTABLE_RECOVERY_"
    "PYTEST_DURATION_SUFFIX_FALSE_REJECT_V1.json"
)
V8_DURATION_SUFFIX_INCIDENT_SIZE_BYTES = 10_834
V8_DURATION_SUFFIX_INCIDENT_SHA256 = (
    "5ce616c66ff1eaed2d18e97296de1b45a7ed9ce8280f6253bc1acc05beed91db"
)
V8_DURATION_SUFFIX_INCIDENT_CANONICAL_BYTES = 9_252
V8_DURATION_SUFFIX_INCIDENT_CANONICAL_SHA256 = (
    "7919232ce35a73aec120ffe5f8dc99052e265f2a8f7409f855e61eec0ed5b297"
)
V8_DURATION_SUFFIX_CORRECTION_RELATIVE = (
    "incidents/"
    "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_V7_PYTEST_DURATION_SUFFIX_"
    "AFTERSTATE_COMMITMENT_CORRECTION_V1.json"
)
V8_DURATION_SUFFIX_CORRECTION_SIZE_BYTES = 4_221
V8_DURATION_SUFFIX_CORRECTION_SHA256 = (
    "bd6a1e07274c99908e0c9bf27e8061f575371a6dd7f892b5a85b40468b3b0a89"
)
V8_DURATION_SUFFIX_CORRECTION_CANONICAL_BYTES = 3_715
V8_DURATION_SUFFIX_CORRECTION_CANONICAL_SHA256 = (
    "e1c7a417516bbb1469e86bb69d0d3772af76c4615b52e0dc24de435bfec4f9c2"
)
V8_CORRECTED_DURATION_INCIDENT_CANONICAL_BYTES = 9_287
V8_CORRECTED_DURATION_INCIDENT_CANONICAL_SHA256 = (
...
FROZEN_V7_AUDIT_ATTEMPT_ID = "postrun_audit_v7__20260811T053854057056Z"
FROZEN_V7_RECOVERY_ATTEMPT_ID = "decode_recovery_v2__20260810T211017500046Z"
FROZEN_V7_AUTH_CREATED_UTC = "2026-08-11T05:38:54.057056Z"
FROZEN_V7_REVIEW_CREATED_UTC = "2026-08-11T05:46:24.609078Z"
FROZEN_V7_GO_CREATED_UTC = "2026-08-11T05:51:30.322606Z"
FROZEN_V7_AUTH_PAYLOAD_CANONICAL_SHA256 = (
    "00ef914127c84519dcb673d562bc6ff01315ded136328eeb388344b2e25ba27f"
)
FROZEN_V7_REVIEW_PAYLOAD_CANONICAL_SHA256 = (
    "3684d84beae8ac7b6fb49b617678c0af5acf4ba2af22a73bb505e4a51dc040ad"
)
FROZEN_V7_GO_PAYLOAD_CANONICAL_SHA256 = (
    "8352320a53ec4a72df2d022a9079b30ff97186409d48143ac97b47e33a6989a2"
)
FROZEN_V7_TEST_EVIDENCE_CANONICAL_SHA256 = (
    "d86248d24b3af7f7b286d1d85ad56a4ccc0a449a0a493495c21193d6b16bf647"
)
V8_PREFLIGHT_RELATIVE = "prelaunch/DECODE_RECOVERY_REAL_PROCESS_PREFLIGHT_V2.json"
V8_PREFLIGHT_IDENTITY = {
    "path": V8_PREFLIGHT_RELATIVE,
    "size_bytes": 38_972,
    "sha256": "5c9b79845c03015f85647833b68603cbed187d3dc09f63c7d214a379b5940481",
}
V8_PREFLIGHT_CANONICAL_BYTES = 33_445
V8_PREFLIGHT_CANONICAL_SHA256 = (
    "5b6fb0976cd1682d74b35319d7224895e5d37acd99d3a624b7cb0c6211a28e0a"
)
V8_PREFLIGHT_TEST_EVIDENCE_CANONICAL_BYTES = 18_759
V8_PREFLIGHT_TEST_EVIDENCE_CANONICAL_SHA256 = (
    "b2d8cfdf1d2e1caa146c56ecefe331cab7670c969bd34370e9c39a060243fecb"
)
V8_PREFLIGHT_TEST_FILE_SUMMARY_PAIRS_CANONICAL_BYTES = 605
V8_PREFLIGHT_TEST_FILE_SUMMARY_PAIRS_CANONICAL_SHA256 = (
    "e20a8920edefbe38aebf66801f998af1fc6d44f591f8b92a8046ff78aa2c2803"
)
V8_PREFLIGHT_ORDERED_SUMMARIES_CANONICAL_BYTES = 149
V8_PREFLIGHT_ORDERED_SUMMARIES_CANONICAL_SHA256 = (
    "4ff61d69b17fc71bb64e59d6bde5c281828424c92055ffdfb2410c247a127f28"
)
V8_PREFLIGHT_AGGREGATE_CANONICAL_BYTES = 453
V8_PREFLIGHT_AGGREGATE_CANONICAL_SHA256 = (
    "a335063641a4385bac815f66d5d8338de1fc3acf22d278b1c2edaee4d4b84eda"
)
V8_PREFLIGHT_LONG_DURATION_SUMMARY = "85 passed in 65.33s (0:01:05)"
...
V8_REVIEW_KEYS = {
    "schema_version", "artifact_type", "status", "verdict", "created_utc",
    "audit_attempt_id", "authorization", "v7_authority_base",
    "v7_live_failure_state", "immutable_v2_preflight_evidence",
    "superseded_v7_auditor", "superseded_v7_auditor_test",
    "superseded_v7_sealer", "superseded_v7_sealer_test", "v8_auditor",
    "v8_auditor_test", "v8_sealer", "v8_sealer_test",
    "recovered_afterstate_commitment", "test_evidence_recheck",
    "independent_checks", "max_spawn_processes", "network_requests_allowed",
    "audit_files_written_allowed", "labels_read_allowed",
    "arrays_2024_read_allowed", "arrays_2025_read_allowed",
...
V8_GO_KEYS = {
    "schema_version", "artifact_type", "status", "created_utc",
    "audit_attempt_id", "authorization", "independent_review",
    "v7_authority_base", "v7_live_failure_state",
    "immutable_v2_preflight_evidence", "superseded_v7_auditor",
    "superseded_v7_auditor_test", "superseded_v7_sealer",
    "superseded_v7_sealer_test", "v8_auditor", "v8_auditor_test",
    "v8_sealer", "v8_sealer_test", "recovery_attempt_id",
...
V8_ZERO_SNAPSHOT_KEYS = {
    "v7_live_failure_state_canonical_sha256",
    "recovered_afterstate_commitment_canonical_sha256",
    "preauthorization_control_namespace", "active_locks",
    "v8_control_temporary_files", "postrun_audit_output_files_present",
    "network_requests", "audit_files_written", "labels_read",
    "arrays_2024_read", "arrays_2025_read", "models_fit",
    "submission_csv_created",
}
V8_TEST_EVIDENCE_KEYS = {
    "schema_version", "artifact_type", "status", "created_utc", "bound_identities",
    "source_compile", "pytest_isolation", "test_runs", "required_test_names",
    "required_test_names_present", "all_exit_codes_zero",
    "production_shape_regression", "real_seven_spawn_regression",
    "stdout_only_regression", "network_guard", "network_requests",
    "audit_files_written", "labels_read", "arrays_2024_read", "arrays_2025_read",
    "models_fit", "submission_csv_created", "frozen_v7_preseal_test_evidence",
}
V8_TEST_RUN_KEYS = {
    "v8_auditor_tests", "v8_sealer_tests", "frozen_v7_auditor_tests",
    "frozen_v7_sealer_tests",
}
V8_TEST_RUN_RECORD_KEYS = {
    "command", "exit_code", "summary", "stdout_sha256", "stderr_sha256",
    "network_guard_installed", "cacheprovider_disabled", "selection_mode",
    "deselected_nodeids", "deselected_count",
}
V8_REQUIRED_TEST_NAMES = (
    "test_real_immutable_v7_authority_base_passes",
    "test_v7_authority_base_path_size_sha_schema_status_or_digest_tamper_fails",
    "test_v7_duration_suffix_false_reject_primary_incident_is_exact",
    "test_v7_duration_suffix_afterstate_commitment_correction_is_exact",
    "test_primary_incident_alone_fails_and_dual_bound_correction_passes",
    "test_correction_pointer_value_identity_or_logical_digest_tamper_fails",
    "test_frozen_v7_reproduces_exact_immutable_pytest_duration_suffix_false_reject",
    "test_v8_pytest_success_summary_parser_accepts_actual_six_summaries",
    "test_v8_pytest_success_summary_parser_accepts_legitimate_rounding_boundaries",
    "test_v8_pytest_success_summary_parser_rejects_malformed_or_inconsistent_suffixes",
    "test_actual_v2_preflight_evidence_commitments_are_exact",
    "test_actual_v2_preflight_evidence_validator_passes",
    "test_v2_preflight_physical_canonical_evidence_or_summary_commitment_tamper_fails",
    "test_v2_preflight_gate_precedes_schema_parquet_data_and_replay",
    "test_late_reuse_revalidates_v7_base_failure_chain_and_v2_preflight",
    "test_v7_production_data_and_replay_core_ast_is_identical",
    "test_compact_recovered_afterstate_commitment_matches_v7_authority",
    "test_compact_commitment_field_or_inventory_digest_tamper_fails",
    "test_full_recovered_afterstate_is_not_embedded_in_v8_authority_controls",
    "test_real_v8_authority_and_full_synthetic_core_proofs_are_compositional",
    "test_full_recovered_production_shape_reaches_transaction_raw_decoded_and_offline_replay",
    "test_unbound_matching_control_namespace_entry_fails_before_data",
    "test_v2_v3_v4_v5_v6_v7_v8_report_candidate_fails_before_data",
    "test_v8_authority_schema_path_status_crosslink_or_command_tamper_fails",
    "test_v8_postaudit_rechecks_v7_chain_failure_correction_preflight_namespace_and_commitment",
    "test_v8_auditor_is_stdout_only_and_writes_zero_files",
    "test_network_target_label_model_and_submission_routes_remain_absent",
    "test_v8_worker_is_importable_in_exactly_seven_spawn_processes",
    "test_v8_review_and_go_never_embed_full_progress_inventory",
    "test_duplicate_json_key_rejection_is_not_bypassed_by_standard_last_wins_parse",
    "test_incidents_cannot_authorize_v7_or_v8_execution",
    "test_v8_actual_root_collect_build_and_self_validator_passes",
    "test_v8_zero_snapshot_and_normalized_namespace_commitments_are_exact",
    "test_v8_control_temporary_destination_set_is_exact27",
    "test_v8_compact_control_size_caps_and_forbidden_inventory_fields",
    "test_v8_authority_and_failure_preflight_gate_precede_any_parquet_or_data_read",
    "test_v8_review_and_go_dual_bind_primary_and_correction",
    "test_v8_parser_uses_integer_hundredths_and_canonical_hms_without_float",
    "test_v8_primary_correction_chronology_equality_or_backdate_fails",
    "test_v8_postauthority_start_end_call_count_and_midrun_drift_fail",
...
V8_PRODUCTION_SHAPE_KEYS = {
    "actual_root_v7_authority_base_validated",
    "primary_duration_suffix_incident_validated",
    "afterstate_commitment_correction_validated",
    "primary_incident_alone_rejected", "corrected_logical_primary_validated",
    "actual_v2_preflight_evidence_validated_before_data",
    "actual_six_pytest_summaries_validated",
    "pytest_duration_suffix_rounding_boundaries_validated",
    "frozen_v7_duration_suffix_false_reject_reproduced",
    "compact_afterstate_commitment_validated",
    "full_afterstate_reconstructed_in_memory",
    "postauthority_start_end_and_drift_validated",
    "original_v1_four_key_identity_passed",
    "historical_current_role_distinction_validated", "transaction_reached",
    "raw_reached", "decoded_reached", "offline_replay_reached",
    "synthetic_fixture", "v7_production_data_and_replay_core_ast_identical",
    "actual_root_collect_build_self_validator_validated",
    "control_namespace_primary_correction_and_v8_exact",
    "full_104_inventory_not_embedded",
}
V8_REVIEW_CHECKS = {
    "v7_authority_base_exact_and_revalidated",
    "v7_authorization_review_go_status_chronology_crosslinks_exact",
    "v7_duration_suffix_false_reject_primary_incident_exact",
    "afterstate_commitment_correction_record_exact",
    "primary_incident_alone_rejected_and_dual_binding_required",
    "corrected_logical_primary_incident_exact",
    "immutable_v2_preflight_physical_and_canonical_exact",
    "immutable_v2_test_evidence_canonical_exact",
    "six_pytest_summary_commitments_exact",
    "pytest_duration_suffix_parser_actual_and_rounding_boundaries_exact",
    "v2_preflight_validation_precedes_schema_parquet_data_and_replay",
    "superseded_v7_auditor_test_sealer_identities_exact",
    "v8_code_test_sealer_identities_exact",
    "v5_v6_and_earlier_authority_transitively_revalidated",
    "original_v1_four_key_provenance_transitively_exact",
    "compact_recovered_afterstate_commitment_exact10",
    "full_recovered_afterstate_reconstructed_in_memory",
    "recovered_afterstate_identity_topology_closure_exact",
    "production_shape_regression_reaches_full_v2_audit_path",
    "real_seven_spawn_v8_worker_importability_pass",
    "full_offline_raw_to_decoded_replay_retained",
    "v7_production_data_and_replay_core_ast_identical",
    "frozen_v7_original_full_suites_bound_and_current_applicable_subsets_green",
    "executing_v8_vs_frozen_v2_v3_v4_v5_v6_v7_role_distinction_exact",
    "stdout_only_zero_write_contract_retained",
    "network_zero_target_free_no_model_submission_scope_retained",
    "full_104_inventory_not_duplicated_in_v8_controls",
    "control_namespace_primary_correction_and_v8_exact",
    "negative_dual_incident_preflight_namespace_and_commitment_tamper_tests_pass",
    "frozen_v7_false_reject_reproduced_and_v8_actual_preflight_positive_passes",
    "actual_root_collect_build_self_validator_passes",
    "v8_authorization_review_go_dual_bind_primary_and_correction",
}
_V8_CANONICAL_MAIN_ACTIVE = False
...
def _v8_parse_pytest_success_summary(value: Any, *, label: str) -> dict[str, Any]:
    """Parse pytest success summaries using integers and canonical HMS only."""
    ...
    skipped_text = match.group(2)
    skipped = int(skipped_text) if skipped_text is not None else 0
    seconds_whole = int(match.group(3))
    fraction_text = match.group(4)
    suffix_present = match.group(5) is not None
    duration_hundredths: int | None = None
    suffix_total_seconds: int | None = None
    ...
    if suffix_present:
        ...
        duration_hundredths = seconds_whole * 100 + int(fraction_text)
        hours_text = str(match.group(5))
        _require(hours_text == str(int(hours_text)), label)
        suffix_total_seconds = (
        ...
        _require(
            ...
            and suffix_total_seconds >= 60
            and suffix_total_seconds in candidates
            and value.endswith(
                f" ({suffix_total_seconds // 3_600}:"
                f"{(suffix_total_seconds % 3_600) // 60:02d}:"
                f"{suffix_total_seconds % 60:02d})"
            ),
            label,
        )
        if duration_hundredths == 6_000:
            _require(suffix_total_seconds == 60, label)
    else:
        if fraction_text is None:
            duration_hundredths = seconds_whole * 100
        elif len(fraction_text) <= 2:
            duration_hundredths = seconds_whole * 100 + int(
                fraction_text.ljust(2, "0")
            )
    return {
        "passed": passed,
        "skipped": skipped,
        ...
        "suffix_total_seconds": suffix_total_seconds,
    }
...
def _validate_recovery_test_evidence(
    ...
    for run, relative in zip(runs, RECOVERY_TEST_RELATIVES, strict=True):
        ...
        _v8_parse_pytest_success_summary(
            summary,
            label=f"immutable recovery pytest result invalid: {relative}",
        )
...
def _v8_expected_immutable_v2_preflight_evidence() -> dict[str, Any]:
    return {
        "preflight": dict(V8_PREFLIGHT_IDENTITY),
        "preflight_payload_canonical_size_bytes": V8_PREFLIGHT_CANONICAL_BYTES,
        "preflight_payload_canonical_sha256": V8_PREFLIGHT_CANONICAL_SHA256,
        "test_evidence_canonical_size_bytes": (
            V8_PREFLIGHT_TEST_EVIDENCE_CANONICAL_BYTES
        ),
        "test_evidence_canonical_sha256": (
            V8_PREFLIGHT_TEST_EVIDENCE_CANONICAL_SHA256
        ),
        "pytest_run_count": 6,
        "test_file_summary_pairs_canonical_size_bytes": (
            V8_PREFLIGHT_TEST_FILE_SUMMARY_PAIRS_CANONICAL_BYTES
        ),
        "test_file_summary_pairs_canonical_sha256": (
            V8_PREFLIGHT_TEST_FILE_SUMMARY_PAIRS_CANONICAL_SHA256
        ),
        "ordered_summaries_canonical_size_bytes": (
            V8_PREFLIGHT_ORDERED_SUMMARIES_CANONICAL_BYTES
        ),
        "ordered_summaries_canonical_sha256": (
            V8_PREFLIGHT_ORDERED_SUMMARIES_CANONICAL_SHA256
        ),
        "aggregate_pytest_summary_canonical_size_bytes": (
            V8_PREFLIGHT_AGGREGATE_CANONICAL_BYTES
        ),
        "aggregate_pytest_summary_canonical_sha256": (
            V8_PREFLIGHT_AGGREGATE_CANONICAL_SHA256
        ),
        "long_duration_run_index": 5,
        "long_duration_summary": V8_PREFLIGHT_LONG_DURATION_SUMMARY,
        "validation_before_schema_parquet_data_and_replay": True,
    }


def _v8_validate_actual_v2_preflight_evidence(root: Path) -> dict[str, Any]:
    """Validate immutable V2 preflight metadata without opening pilot/data files."""

    authorization_path = path_under(root, RECOVERY_AUTH_RELATIVE)
    preflight_path = path_under(root, V8_PREFLIGHT_RELATIVE)
    _v4_verify_exact_root_identity(
        root,
        V4_V2_CONTROL_IDENTITIES["recovery_authorization_v2"],
        V4_V2_CONTROL_IDENTITIES["recovery_authorization_v2"],
        label="V8 immutable V2 recovery authorization",
    )
    _v4_verify_exact_root_identity(
        root,
        V8_PREFLIGHT_IDENTITY,
        V8_PREFLIGHT_IDENTITY,
        label="V8 immutable V2 process preflight",
    )
    authorization = _v5_load_strict_json(
        authorization_path, label="V8 immutable V2 recovery authorization"
    )
    preflight = _v5_load_strict_json(
        preflight_path, label="V8 immutable V2 process preflight"
    )
    preflight_bytes = _v4_canonical_bytes(preflight)
    _require(
        len(preflight_bytes) == V8_PREFLIGHT_CANONICAL_BYTES
        and hashlib.sha256(preflight_bytes).hexdigest()
        == V8_PREFLIGHT_CANONICAL_SHA256,
        "V8 immutable V2 preflight canonical identity mismatch",
    )
    preflight_keys = {
        "schema_version", "artifact_type", "status", "created_utc", "incident",
        "flawed_launch_incident", "launch_identity_correction",
        "superseded_v1_chain", "superseded_v1_support", "recovery_runner",
        "recovery_module", "recovery_bootstrap", "recovery_test",
        "recovery_bootstrap_test", "recovery_runner_test", "postrun_auditor",
        "postrun_auditor_test", "recovery_sealer", "recovery_sealer_test",
        "bootstrap_trust_policy", "runtime_lock", "bootstrap_import_contract",
        "test_evidence", "process_scheduling_flake_incident",
        "sealer_entrypoint_incident", "real_grib_pilot", "max_spawn_processes",
        "thread_decoders", "network_requests",
        "production_decode_task_worker_real_test",
        "stdlib_bootstrap_worker_real_test", "poisoned_pyc_source_execution_test",
        "bootstrap_ast_stdlib_policy_pass", "python_dont_write_bytecode_env",
        "python_dont_write_bytecode_flag", "python_pycache_prefix_absent",
        "bootstrap_matching_pyc_absent_before_tests",
        "bootstrap_matching_pyc_absent_after_tests", "all_seven_worker_pids_observed",
        "pilot_report", "production_worker_report", "run_prefix_regression",
        "focused_test_result", "source_compile_result", "labels_read",
        "arrays_2024_read", "arrays_2025_read", "models_fit",
        "submission_csv_created",
    }
    _require(set(preflight) == preflight_keys, "V8 immutable V2 preflight schema mismatch")
    expected_bootstrap_import_contract = _validate_recovery_bootstrap_import_contract(
        authorization.get("bootstrap_import_contract")
    )
    external_paths = {
        "original_runner": RUNNER_DEFAULT,
        "recovery_runner": RECOVERY_RUNNER,
        "recovery_module": RECOVERY_MODULE,
        "recovery_bootstrap": RECOVERY_BOOTSTRAP,
        "recovery_test": RECOVERY_TEST,
    ...
    for role, path in external_paths.items():
        external_actuals[role] = verify_identity(
            authorization.get(role, {}),
            path,
            root=None,
            label=f"V8 immutable V2 preflight {role}",
        )
        if role in RECOVERY_FROZEN_EXTERNAL_SHA256:
            _require(
                external_actuals[role]["sha256"]
                == RECOVERY_FROZEN_EXTERNAL_SHA256[role],
                f"V8 immutable V2 frozen external mismatch: {role}",
            )
    for role in (
        ...
        _require(
            preflight.get(role) == authorization.get(role),
            f"V8 immutable V2 preflight {role} binding mismatch",
        )
    ...
    for role, path in {
        ...
        sealer_actuals[role] = verify_identity(
            preflight.get(role, {}),
            path,
            root=None,
            label=f"V8 immutable V2 preflight {role}",
        ...
        _require(
            (
                sealer_actuals[role]["size_bytes"],
                sealer_actuals[role]["sha256"],
            )
            == V4_V2_SUPPORT_SIZE_SHA256[role],
            f"V8 immutable V2 frozen sealer mismatch: {role}",
        )
    evidence = preflight.get("test_evidence")
    evidence_bytes = _v4_canonical_bytes(evidence)
    _require(
        len(evidence_bytes) == V8_PREFLIGHT_TEST_EVIDENCE_CANONICAL_BYTES
        and hashlib.sha256(evidence_bytes).hexdigest()
        == V8_PREFLIGHT_TEST_EVIDENCE_CANONICAL_SHA256,
        "V8 immutable V2 test-evidence canonical identity mismatch",
    )
    _validate_recovery_test_evidence(
        evidence, preflight, external_actuals, sealer_actuals
    )
    _require(isinstance(evidence, Mapping), "V8 immutable V2 test evidence absent")
    runs = evidence.get("pytest_runs")
    _require(isinstance(runs, list) and len(runs) == 6, "V8 immutable V2 run count mismatch")
    pairs = [
        {"test_file": run["test_file"], "summary": run["summary"]}
        for run in runs
    ]
    summaries = [str(run["summary"]) for run in runs]
    aggregate = evidence.get("pytest_summary")
    for payload, size, digest, label in (
        (pairs, V8_PREFLIGHT_TEST_FILE_SUMMARY_PAIRS_CANONICAL_BYTES,
         V8_PREFLIGHT_TEST_FILE_SUMMARY_PAIRS_CANONICAL_SHA256, "summary pairs"),
        (summaries, V8_PREFLIGHT_ORDERED_SUMMARIES_CANONICAL_BYTES,
         V8_PREFLIGHT_ORDERED_SUMMARIES_CANONICAL_SHA256, "ordered summaries"),
        (aggregate, V8_PREFLIGHT_AGGREGATE_CANONICAL_BYTES,
         V8_PREFLIGHT_AGGREGATE_CANONICAL_SHA256, "aggregate summary"),
    ):
        canonical = _v4_canonical_bytes(payload)
        _require(
            len(canonical) == size and hashlib.sha256(canonical).hexdigest() == digest,
            f"V8 immutable V2 {label} commitment mismatch",
        )
    _require(
        summaries[5] == V8_PREFLIGHT_LONG_DURATION_SUMMARY
        and preflight.get("focused_test_result") == aggregate
        and preflight.get("source_compile_result") == evidence.get("source_compile_result")
        ...
        == authorization.get("superseded_v1_support")
        and preflight.get("bootstrap_trust_policy") == RECOVERY_BOOTSTRAP_TRUST_POLICY
        ...
        "V8 immutable V2 preflight semantic mismatch",
    )
    require_zero_facts(
        preflight,
        {
            "labels_read": False, "arrays_2024_read": False,
            "arrays_2025_read": False, "models_fit": 0,
            "submission_csv_created": False,
        },
        label="V8 immutable V2 process preflight",
    )
    _validate_recovery_pilot_report(preflight.get("pilot_report"), label="V8 sealed pilot report")
    _validate_recovery_production_worker_report(preflight.get("production_worker_report"))
    return {
        "commitment": _v8_expected_immutable_v2_preflight_evidence(),
...
def v8_spawn_probe_barrier_initializer(barrier: Any) -> None:
    """V8 evidence initializer proving all seven spawned workers rendezvous."""

    barrier.wait(timeout=120)


def _v8_required_command(
    root: Path, authorization_path: Path, go_path: Path
) -> list[str]:
    return [
        str(Path(sys.executable).resolve()), "-B", "-m",
...
def _v8_require_canonical_runtime_entrypoint(
    root: Path, authorization_path: Path, go_path: Path
) -> None:
    _require(
        __spec__ is not None
        and __spec__.name == "scripts.audit_noaa_gfs_multiseason_raw_postrun_v8"
        and __package__ == "scripts",
        "V8 production audit requires the canonical -m module entrypoint",
    )
    _require(
        sys.dont_write_bytecode is True
        and os.environ.get("PYTHONDONTWRITEBYTECODE") == "1"
        and "PYTHONPYCACHEPREFIX" not in os.environ
        and sys.pycache_prefix is None,
        "V8 production audit bytecode/cache environment mismatch",
    )
    expected_argv = [
        str(Path(__file__).resolve()), "--root", str(root.resolve()),
        "--authorization", str(authorization_path.resolve()),
    ...
    actual_argv = [str(Path(sys.argv[0]).resolve()), *sys.argv[1:]]
    _require(actual_argv == expected_argv, "V8 production argv is not exact canonical order")
    actual_orig_argv = [str(Path(sys.orig_argv[0]).resolve()), *sys.orig_argv[1:]]
    _require(
        actual_orig_argv == _v8_required_command(root, authorization_path, go_path),
        "V8 production interpreter/module argv is not exact authorized command",
    )
...
V8_PYTEST_NETWORK_GUARD_SOURCE = """import socket,sys
def _deny(*_args,**_kwargs):
    raise RuntimeError("network forbidden in immutable V8 test subprocess")
def _audit(event,_args):
    if event in {"socket.__new__","socket.bind","socket.connect","socket.connect_ex","socket.getaddrinfo","socket.gethostbyaddr","socket.gethostbyname","socket.getnameinfo","socket.sendmsg","socket.sendto"}:
        _deny()
sys.addaudithook(_audit)
for _name in ("create_connection","getaddrinfo","gethostbyaddr","gethostbyname","getnameinfo"):
...
def _v8_test_command(relative: str) -> list[str]:
    command = [
        str(Path(sys.executable).resolve()), "-B", "-c",
        V8_PYTEST_NETWORK_GUARD_SOURCE, "-q", "-p", "no:cacheprovider", relative,
    ]
...
def _v8_validate_bound_test_run_summary(role: str, value: Any) -> None:
    ...
    if role in frozen_counts:
        ...
        prefix = (
            f"{passed} passed, {skipped} skipped, {deselected} deselected in "
        )
        _require(
            summary.startswith(prefix)
            and summary.count("deselected") == 1,
            f"V8 frozen pytest deselection summary mismatch: {role}",
        )
        normalized = (
            f"{passed} passed, {skipped} skipped in " + summary[len(prefix):]
        )
        parsed = _v8_parse_pytest_success_summary(
            normalized, label=f"V8 frozen pytest summary invalid: {role}"
        )
        _require(
            parsed["passed"] == passed and parsed["skipped"] == skipped,
            f"V8 frozen pytest summary count mismatch: {role}",
        )
    else:
        _require(
            "deselected" not in summary,
            f"V8 executing pytest suite unexpectedly deselected tests: {role}",
        )
        _v8_parse_pytest_success_summary(
            summary, label=f"V8 executing pytest summary invalid: {role}"
        )


def _v8_frozen_v7_preseal_test_evidence(
    ...
    _require(
        ...
        and {
            role: {
                key: actual_runs[role].get(key)
                for key in ("exit_code", "summary", "stdout_sha256", "stderr_sha256")
            }
            for role in original_full_runs
            if isinstance(actual_runs.get(role), Mapping)
        }
        == original_full_runs,
        "V8 frozen V7 original full-suite evidence mismatch",
    )
    return {
        "authorization": dict(FROZEN_V7_CONTROL_IDENTITIES["authorization"]),
        "canonical_size_bytes": 14_174,
        "canonical_sha256": FROZEN_V7_TEST_EVIDENCE_CANONICAL_SHA256,
...
def _v8_control_destination_relatives() -> tuple[str, ...]:
    return (
        FROZEN_V3_AUTH_RELATIVE, FROZEN_V3_REVIEW_RELATIVE,
        FROZEN_V3_CANONICAL_GO_RELATIVE, FROZEN_V3_MISPLACED_GO_RELATIVE,
        V4_AUTH_RELATIVE, V4_REVIEW_RELATIVE, V4_GO_RELATIVE,
        ...
        V6_AUTH_RELATIVE, V6_REVIEW_RELATIVE, V6_GO_RELATIVE,
        V7_AUTH_RELATIVE, V7_REVIEW_RELATIVE, V7_GO_RELATIVE,
        V8_AUTH_RELATIVE, V8_REVIEW_RELATIVE, V8_GO_RELATIVE,
        V2_FALSE_REJECT_INCIDENT_RELATIVE, V4_PATH_MISPUBLISH_INCIDENT_RELATIVE,
        V5_TRANSPORT_INCIDENT_RELATIVE, V5_TRANSPORT_CORRECTION_RELATIVE,
        V6_HISTORICAL_FALSE_REJECT_INCIDENT_RELATIVE,
        V7_TIMESTAMP_FALSE_REJECT_INCIDENT_RELATIVE,
...
def _v8_control_temporary_files(root: Path) -> list[str]:
    matches: list[str] = []
    for relative in _v8_control_destination_relatives():
        destination = path_under(root, relative)
        parent = destination.parent
...
def _v8_postrun_report_candidates(root: Path) -> list[str]:
    return [
        relative
        for relative in V8_POSTRUN_REPORT_CANDIDATES
        if os.path.lexists(str(path_under(root, relative)))
    ]


def _v8_validate_control_namespace(root: Path) -> dict[str, list[str]]:
    forbidden = (
        FROZEN_V3_CANONICAL_GO_RELATIVE, V4_GO_RELATIVE,
        V6_AUTH_RELATIVE, V6_REVIEW_RELATIVE, V6_GO_RELATIVE,
    )
    ...
    expected = {
        "prereg": {
            Path(FROZEN_V3_AUTH_RELATIVE).name,
            Path(FROZEN_V3_MISPLACED_GO_RELATIVE).name,
            Path(V4_AUTH_RELATIVE).name, Path(V5_AUTH_RELATIVE).name,
            Path(V7_AUTH_RELATIVE).name, Path(V8_AUTH_RELATIVE).name,
        },
        "independent_redteam": {
            Path(FROZEN_V3_REVIEW_RELATIVE).name, Path(V4_REVIEW_RELATIVE).name,
            Path(V5_REVIEW_RELATIVE).name, Path(V5_GO_RELATIVE).name,
            Path(V7_REVIEW_RELATIVE).name, Path(V7_GO_RELATIVE).name,
            Path(V8_REVIEW_RELATIVE).name, Path(V8_GO_RELATIVE).name,
        },
        "incidents": {
            Path(V2_FALSE_REJECT_INCIDENT_RELATIVE).name,
            Path(V4_PATH_MISPUBLISH_INCIDENT_RELATIVE).name,
            ...
            Path(V6_HISTORICAL_FALSE_REJECT_INCIDENT_RELATIVE).name,
            Path(V7_TIMESTAMP_FALSE_REJECT_INCIDENT_RELATIVE).name,
            Path(V8_DURATION_SUFFIX_INCIDENT_RELATIVE).name,
            Path(V8_DURATION_SUFFIX_CORRECTION_RELATIVE).name,
        },
    }
    prefixes = {
        "prereg": "decode_recovery_postrun_audit_",
    ...
    for relative, expected_names in expected.items():
        parent = path_under(root, relative)
        _require(parent.is_dir() and not _linklike(parent), f"V8 namespace invalid: {relative}")
        matched: list[str] = []
        for entry in parent.iterdir():
            scan_name = entry.name.casefold().lstrip(".")
            if scan_name.startswith(prefixes[relative]):
                _require(entry.is_file() and not _linklike(entry), "V8 namespace object invalid")
                matched.append(entry.name)
        _require(
            set(matched) == expected_names
            and len({name.casefold() for name in matched}) == len(matched),
        ...
        result[relative] = sorted(matched)
    encoded = _v4_canonical_bytes(result)
    _require(
        {key: len(value) for key, value in result.items()}
        == {"prereg": 6, "independent_redteam": 8, "incidents": 8}
        and len(encoded) == 1_552
        and hashlib.sha256(encoded).hexdigest()
        == "16037d9325689aa88de5fa69e933d181502616795cfea9e30c6444804bcfc1a4",
        "V8 postauthority namespace canonical commitment mismatch",
    )
    return result


def _v8_validate_policy(payload: Mapping[str, Any], *, label: str) -> None:
    _v7_validate_policy(payload, label=label)


def _v8_assert_compact_control(payload: Mapping[str, Any], *, label: str) -> None:
    _v7_assert_compact_control(payload, label=label)


def _v8_validate_zero_snapshot(
    root: Path, payload: Any, *, failure_state: Mapping[str, Any]
) -> None:
    _require(
        isinstance(payload, Mapping) and set(payload) == V8_ZERO_SNAPSHOT_KEYS,
        "V8 zero-mutation snapshot schema mismatch",
    )
    expected_pre_namespace = {
        "counts": {"prereg": 5, "independent_redteam": 6, "incidents": 8},
        "canonical_size_bytes": 1_388,
        "canonical_sha256": "c16a239873847da42d138b5cab941c3eb81e5141aaebdabb2695140a3f90347c",
    }
    _require(
        payload.get("v7_live_failure_state_canonical_sha256")
        == canonical_payload_sha256(failure_state)
        and payload.get("recovered_afterstate_commitment_canonical_sha256")
        == V5_RECOVERED_AFTERSTATE_COMMITMENT_CANONICAL_SHA256
        and payload.get("preauthorization_control_namespace") == expected_pre_namespace
        and payload.get("active_locks")
        == {
            "raw": {"path": "raw/RAW_LAUNCH_ACTIVE.lock", "present": False},
            "decoded": {"path": "decoded/DECODE_RECOVERY_ACTIVE.lock", "present": False},
        }
        and payload.get("v8_control_temporary_files")
        == {
            "checked_destination_relative_paths": list(_v8_control_destination_relatives()),
            "matching_temporary_files": [],
        }
        and payload.get("postrun_audit_output_files_present") == 0
        and payload.get("network_requests") == 0
        ...
        and payload.get("models_fit") == 0
        and payload.get("submission_csv_created") is False,
        "V8 zero-mutation snapshot value mismatch",
    )
    _require(
        not os.path.lexists(str(path_under(root, "raw/RAW_LAUNCH_ACTIVE.lock")))
        and not os.path.lexists(str(path_under(root, "decoded/DECODE_RECOVERY_ACTIVE.lock")))
        and _v8_control_temporary_files(root) == []
        and _v8_postrun_report_candidates(root) == [],
        "V8 current zero-mutation filesystem mismatch",
    )


def _v8_validate_duration_suffix_incident_chain(
    root: Path, primary_record: Any, correction_record: Any
) -> dict[str, Any]:
    """Apply the sole correction before interpreting the rejected V7 incident."""

    primary_expected = {
        "path": V8_DURATION_SUFFIX_INCIDENT_RELATIVE,
        "size_bytes": V8_DURATION_SUFFIX_INCIDENT_SIZE_BYTES,
        "sha256": V8_DURATION_SUFFIX_INCIDENT_SHA256,
    }
    correction_expected = {
        "path": V8_DURATION_SUFFIX_CORRECTION_RELATIVE,
        "size_bytes": V8_DURATION_SUFFIX_CORRECTION_SIZE_BYTES,
        "sha256": V8_DURATION_SUFFIX_CORRECTION_SHA256,
    }
    _v4_verify_exact_root_identity(
        root, primary_record, primary_expected, label="V7 duration-suffix incident"
    )
    _v4_verify_exact_root_identity(
        root, correction_record, correction_expected,
        label="V7 duration-suffix afterstate correction",
    )
    raw_primary = _v5_load_strict_json(
        path_under(root, V8_DURATION_SUFFIX_INCIDENT_RELATIVE),
        label="V7 duration-suffix incident",
    )
    correction = _v5_load_strict_json(
        path_under(root, V8_DURATION_SUFFIX_CORRECTION_RELATIVE),
        label="V7 duration-suffix afterstate correction",
    )
    raw_bytes = _v4_canonical_bytes(raw_primary)
    correction_bytes = _v4_canonical_bytes(correction)
    _require(
        len(raw_bytes) == V8_DURATION_SUFFIX_INCIDENT_CANONICAL_BYTES
        and hashlib.sha256(raw_bytes).hexdigest()
        == V8_DURATION_SUFFIX_INCIDENT_CANONICAL_SHA256
        and len(correction_bytes) == V8_DURATION_SUFFIX_CORRECTION_CANONICAL_BYTES
        and hashlib.sha256(correction_bytes).hexdigest()
        == V8_DURATION_SUFFIX_CORRECTION_CANONICAL_SHA256,
        "V7 duration-suffix incident/correction canonical identity mismatch",
    )

    # The correction is completely validated before any primary semantics are
    # consumed.  The raw primary is retained only as immutable rejected history.
    _require(
        set(correction)
        == {
            "schema_version", "artifact_type", "status", "created_utc",
            "authority_scope", "erroneous_incident", "correction",
            "independent_validation", "prohibitions", "required_v8_binding",
        }
        and correction.get("schema_version") == 1
        and correction.get("artifact_type")
        == "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_V7_IMMUTABLE_RECOVERY_PYTEST_DURATION_SUFFIX_FALSE_REJECT_AFTERSTATE_COMMITMENT_CORRECTION_V1"
        and correction.get("status")
        == "SEALED_V7_DURATION_SUFFIX_FALSE_REJECT_AFTERSTATE_COMMITMENT_CORRECTION_NO_V8_AUTHORITY_DUAL_BINDING_REQUIRED",
        "V7 duration-suffix correction header mismatch before primary use",
    )
    _require(
        correction.get("authority_scope")
        == {
            "correction_record_write_authorized": True,
            "documentary_only": True,
            "live_postrun_auditor_authorized": False,
            ...
            "v8_code_test_control_or_execution_authorized_by_this_record": False,
        }
        and correction.get("prohibitions")
        == {
            "do_not_delete_move_rename_copy_hardlink_or_mutate_primary_incident": True,
            "do_not_execute_live_auditor": True,
            "do_not_fit_models_or_create_submission_csv": True,
            "do_not_publish_v8_controls_before_dual_binding_and_tests": True,
            "do_not_read_labels_or_2024_2025_arrays": True,
            "do_not_retry_v7": True,
            "do_not_use_network": True,
        },
        "V7 duration-suffix correction authority/prohibition mismatch",
    )
    erroneous = correction.get("erroneous_incident")
    override = correction.get("correction")
    _require(
        erroneous
        == {
            "artifact_type": (
            ...
            "canonical_payload": {
                "canonical_sha256": V8_DURATION_SUFFIX_INCIDENT_CANONICAL_SHA256,
                "canonical_size_bytes": V8_DURATION_SUFFIX_INCIDENT_CANONICAL_BYTES,
            },
            **primary_expected,
            "status": (
                "SEALED_V7_LIVE_POSTRUN_AUDITOR_PYTEST_DURATION_SUFFIX_FALSE_"
                "REJECT_AFTER_FULL_REPLAY_NO_REPORT_V8_SUPERSESSION_REQUIRED"
            ),
        }
        and isinstance(override, Mapping)
        and set(override)
        == {
            "all_other_primary_incident_facts_unchanged", "authoritative_commitment",
            "authoritative_source", "corrected_json_pointer",
            "corrected_logical_primary_incident", "corrected_value",
            "erroneous_commitment", "erroneous_json_pointer", "operation",
            "this_is_the_only_authoritative_override",
        }
        and override.get("all_other_primary_incident_facts_unchanged") is True
        and override.get("authoritative_commitment")
        == {
            "canonical_sha256": V5_RECOVERED_AFTERSTATE_COMMITMENT_CANONICAL_SHA256,
            "canonical_size_bytes": V5_RECOVERED_AFTERSTATE_COMMITMENT_CANONICAL_BYTES,
        }
        and override.get("authoritative_source")
        == {
            "json_pointer": "/recovered_afterstate_commitment/recovery_progress_file_count",
            "path": V7_AUTH_RELATIVE,
            "sha256": FROZEN_V7_CONTROL_IDENTITIES["authorization"]["sha256"],
            "size_bytes": FROZEN_V7_CONTROL_IDENTITIES["authorization"]["size_bytes"],
            "value": 104,
        }
        and override.get("corrected_json_pointer")
        == "/postfailure_state/recovered_afterstate_commitment/recovery_progress_file_count"
        and override.get("erroneous_json_pointer")
        == "/postfailure_state/recovered_afterstate_commitment/recovery_progress_file_count"
        and override.get("operation") == "ADD_MISSING_FIELD"
        and override.get("corrected_value") == 104
        and override.get("corrected_logical_primary_incident")
        == {
            "canonical_sha256": V8_CORRECTED_DURATION_INCIDENT_CANONICAL_SHA256,
            "canonical_size_bytes": V8_CORRECTED_DURATION_INCIDENT_CANONICAL_BYTES,
        }
        and override.get("this_is_the_only_authoritative_override") is True,
        "V7 duration-suffix exact correction pointer/value mismatch",
    )
    _require(
        ...
        == {
            ...
            "correction_relative_path": V8_DURATION_SUFFIX_CORRECTION_RELATIVE,
            "must_bind_correction_record_identity": True,
            "must_bind_primary_incident_identity": True,
            "primary_incident_alone_must_fail": True,
            "primary_incident_relative_path": V8_DURATION_SUFFIX_INCIDENT_RELATIVE,
            "status": "REQUIRED_NOT_YET_AUTHORIZED",
        },
        "V7 duration-suffix correction validation/binding mismatch",
    )
    postfailure = raw_primary.get("postfailure_state")
    _require(
        isinstance(postfailure, Mapping)
        and isinstance(postfailure.get("recovered_afterstate_commitment"), Mapping)
        and "recovery_progress_file_count"
        not in postfailure["recovered_afterstate_commitment"],
        "V7 primary incident is not the declared one-field omission",
    )
    corrected = json.loads(json.dumps(raw_primary, ensure_ascii=False))
    corrected["postfailure_state"]["recovered_afterstate_commitment"][
        "recovery_progress_file_count"
    ] = 104
    corrected_bytes = _v4_canonical_bytes(corrected)
    _require(
        len(corrected_bytes) == V8_CORRECTED_DURATION_INCIDENT_CANONICAL_BYTES
        and hashlib.sha256(corrected_bytes).hexdigest()
        == V8_CORRECTED_DURATION_INCIDENT_CANONICAL_SHA256,
        "corrected V7 duration-suffix incident logical identity mismatch",
    )
    ...
    _require(
        ...
        == {
            "schema_version", "artifact_type", "status", "created_utc",
            "authority_scope", "failed_execution", "immutable_v7_chain",
            "root_cause", "exact_mismatch_set", "test_gap", "postfailure_state",
            "prohibitions", "required_v8_supersession",
        }
        and primary.get("schema_version") == 1
        and primary.get("artifact_type")
        == "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_V7_IMMUTABLE_RECOVERY_PYTEST_DURATION_SUFFIX_FALSE_REJECT_INCIDENT"
        and primary.get("status")
        == "SEALED_V7_LIVE_POSTRUN_AUDITOR_PYTEST_DURATION_SUFFIX_FALSE_REJECT_AFTER_FULL_REPLAY_NO_REPORT_V8_SUPERSESSION_REQUIRED"
        and primary.get("authority_scope")
        == {"documentary_only": True, "v7_retry_authorized": False, "v8_authorized": False}
        and primary.get("prohibitions")
        == {
            "fit_models_or_create_submission_csv": True,
            "network_access": True,
            "overwrite_or_edit_v7_code_controls_or_incidents": True,
            "publish_v8_controls_before_incident_and_tests": True,
            "read_labels_or_2024_2025_arrays": True,
            "retry_v7": True,
        },
        "corrected V7 duration-suffix incident header/authority mismatch",
    )
    failure = primary.get("failed_execution")
    mismatch_set = primary.get("exact_mismatch_set")
    _require(
        isinstance(mismatch_set, list)
        and len(mismatch_set) == 1
        and isinstance(mismatch_set[0], Mapping),
        "corrected V7 duration-suffix exact mismatch inventory invalid",
    )
    mismatch = mismatch_set[0]
    root_cause = primary.get("root_cause")
    required = primary.get("required_v8_supersession")
    chain = primary.get("immutable_v7_chain")
    corrected_postfailure = primary.get("postfailure_state")
    _require(
        isinstance(failure, Mapping)
        and failure.get("exit_code") == 1
        and failure.get("wall_seconds") == 266.4
        and failure.get("full_offline_replay_returned_before_failure") is True
        and failure.get("success_report_constructed") is False
        and failure.get("persisted_report_files") == 0
        and failure.get("audit_files_written") == 0
        and failure.get("audit_network_requests_reported") == 0
        and failure.get("stdout_pretty_lf")
        == {
            "size_bytes": 307,
            "sha256": "1dde5ef1aef95e29fa04a1efb32f179bf8dfacd4ff99a1d7408b53e38ae844ac",
        }
        and failure.get("stdout_payload", {}).get("reason")
        == "immutable recovery pytest result invalid: tests/test_noaa_gfs_multiseason_raw_postrun_v2.py"
        and set(mismatch)
        == {
            "affected_summary_count", "exit_code", "field", "observed",
            "other_pytest_summaries_matching_v7_regex", "other_run_fields_valid",
            "preflight", "stderr_sha256", "stdout_sha256", "test_file",
            "v7_regex", "v7_regex_match",
        }
        and mismatch.get("preflight") == V8_PREFLIGHT_IDENTITY
        and mismatch.get("observed") == V8_PREFLIGHT_LONG_DURATION_SUMMARY
        and mismatch.get("affected_summary_count") == 1
        and mismatch.get("other_pytest_summaries_matching_v7_regex") == 5
        and mismatch.get("v7_regex_match") is False
        and isinstance(root_cause, Mapping)
        and root_cause.get("category")
        == "PYTEST_LONG_DURATION_REDUNDANT_HMS_SUFFIX_FALSE_REJECT"
        and root_cause.get("actual_six_summary_proof")
        == {"v7_match_count": 5, "v8_match_and_consistent_count": 6}
        and root_cause.get("pytest_test_failure") is False
        and root_cause.get("code_or_control_identity_failure") is False
        and root_cause.get("data_or_replay_failure") is False
        and isinstance(required, Mapping)
        and required.get("incident_relative_path") == V8_DURATION_SUFFIX_INCIDENT_RELATIVE
        and required.get("must_bind_this_incident_identity") is True
        and required.get("new_paths_only") is True
        and required.get("audit_report_file") is None
        and required.get("status") == "REQUIRED_NOT_YET_AUTHORIZED"
        and isinstance(corrected_postfailure, Mapping)
        and corrected_postfailure.get("recovered_afterstate_commitment")
        == V5_RECOVERED_AFTERSTATE_COMMITMENT,
        "corrected V7 duration-suffix failure semantics mismatch",
    )
    _require(
        isinstance(chain, Mapping)
        and chain.get("audit_attempt_id") == FROZEN_V7_AUDIT_ATTEMPT_ID
        and chain.get("recovery_attempt_id") == FROZEN_V7_RECOVERY_ATTEMPT_ID
        and chain.get("controls")
        == {
            "authorization": FROZEN_V7_CONTROL_IDENTITIES["authorization"],
            "independent_review": FROZEN_V7_CONTROL_IDENTITIES["independent_review"],
            "independent_go": FROZEN_V7_CONTROL_IDENTITIES["independent_go"],
        }
        and chain.get("code_and_tests")
        == {
            role.removeprefix("superseded_"): expected
            for role, expected in FROZEN_V7_SOURCE_IDENTITIES.items()
        },
        "V7 duration-suffix immutable chain mismatch",
    )
    primary_created = _v7_parse_rfc3339_utc_100ns(
        primary.get("created_utc"), label="V7 duration-suffix incident"
    )
    correction_created = _v7_parse_rfc3339_utc_100ns(
        correction.get("created_utc"), label="V7 duration-suffix correction"
    )
    _require(
        primary_created["raw"] == "2026-08-11T06:14:43.374633Z"
        and correction_created["raw"] == "2026-08-11T06:43:59.084809Z"
        and primary_created["ticks_100ns"] < correction_created["ticks_100ns"],
        "V7 duration-suffix incident/correction chronology mismatch",
    )
    state = {
        "primary_incident": dict(primary_expected),
        "correction_record": dict(correction_expected),
        "primary_incident_alone_must_fail": True,
        "correction_must_be_applied_before_semantic_use": True,
        "corrected_logical_primary_incident": {
            "canonical_size_bytes": V8_CORRECTED_DURATION_INCIDENT_CANONICAL_BYTES,
            "canonical_sha256": V8_CORRECTED_DURATION_INCIDENT_CANONICAL_SHA256,
        },
        "failure_reason": (
    ...
    _require(len(state) == 15, "V8 live-failure state schema mismatch")
    return {
        "state": state,
        "primary_identity": dict(primary_expected),
        "correction_identity": dict(correction_expected),
...
def _v8_expected_v7_authority_base() -> dict[str, Any]:
    return {
        "authorization": dict(FROZEN_V7_CONTROL_IDENTITIES["authorization"]),
        "independent_review": dict(FROZEN_V7_CONTROL_IDENTITIES["independent_review"]),
        "independent_go": dict(FROZEN_V7_CONTROL_IDENTITIES["independent_go"]),
        "audit_attempt_id": FROZEN_V7_AUDIT_ATTEMPT_ID,
        "recovery_attempt_id": FROZEN_V7_RECOVERY_ATTEMPT_ID,
        ...
        "review_payload_canonical_sha256": FROZEN_V7_REVIEW_PAYLOAD_CANONICAL_SHA256,
        "go_payload_canonical_sha256": FROZEN_V7_GO_PAYLOAD_CANONICAL_SHA256,
        "authorization_test_evidence_canonical_sha256": (
            FROZEN_V7_TEST_EVIDENCE_CANONICAL_SHA256
        ),
        "recovered_afterstate_commitment_canonical_sha256": (
...
def _v8_validate_frozen_v7_zero_snapshot(payload: Any) -> None:
    _require(
        isinstance(payload, Mapping)
        and set(payload) == V7_ZERO_SNAPSHOT_KEYS
        and payload.get("incident_postfailure_state_canonical_sha256")
        == V7_TIMESTAMP_INCIDENT_POSTFAILURE_CANONICAL_SHA256
        and payload.get("recovered_afterstate_commitment_canonical_sha256")
        == V5_RECOVERED_AFTERSTATE_COMMITMENT_CANONICAL_SHA256
        and payload.get("active_locks")
        ...
        and payload.get("models_fit") == 0
        and payload.get("submission_csv_created") is False,
        "frozen V7 zero-mutation snapshot mismatch",
    )


def _v8_load_and_validate_v7_authority_base(
    root: Path, declared_base: Any
) -> dict[str, Any]:
    expected_base = _v8_expected_v7_authority_base()
    _require(
        isinstance(declared_base, Mapping)
        and set(declared_base) == set(expected_base)
        and declared_base == expected_base,
        "V8 frozen V7 authority-base summary mismatch",
    )
    paths = {
        "authorization": path_under(root, V7_AUTH_RELATIVE),
        "independent_review": path_under(root, V7_REVIEW_RELATIVE),
        "independent_go": path_under(root, V7_GO_RELATIVE),
    }
    for role, expected in FROZEN_V7_CONTROL_IDENTITIES.items():
        _v4_verify_exact_root_identity(
            root, declared_base[role], expected, label=f"V8 frozen V7 {role}"
        )
    authorization = _v5_load_strict_json(paths["authorization"], label="frozen V7 authorization")
    review = _v5_load_strict_json(paths["independent_review"], label="frozen V7 review")
    go = _v5_load_strict_json(paths["independent_go"], label="frozen V7 GO")
    for payload, keys, digest, label in (
        (authorization, V7_AUTH_KEYS, FROZEN_V7_AUTH_PAYLOAD_CANONICAL_SHA256,
         "frozen V7 authorization"),
        (review, V7_REVIEW_KEYS, FROZEN_V7_REVIEW_PAYLOAD_CANONICAL_SHA256,
         "frozen V7 review"),
        (go, V7_GO_KEYS, FROZEN_V7_GO_PAYLOAD_CANONICAL_SHA256, "frozen V7 GO"),
    ):
        _require(
            set(payload) == keys and canonical_payload_sha256(payload) == digest,
            f"{label} schema/canonical digest mismatch",
        )
        _v7_assert_compact_control(payload, label=label)
    auth_created = _v7_parse_rfc3339_utc_100ns(
        authorization.get("created_utc"), label="frozen V7 authorization"
    )
    review_created = _v7_parse_rfc3339_utc_100ns(
        review.get("created_utc"), label="frozen V7 review"
    )
    go_created = _v7_parse_rfc3339_utc_100ns(go.get("created_utc"), label="frozen V7 GO")
    _require(
        auth_created["raw"] == FROZEN_V7_AUTH_CREATED_UTC
        and review_created["raw"] == FROZEN_V7_REVIEW_CREATED_UTC
        and go_created["raw"] == FROZEN_V7_GO_CREATED_UTC
        and auth_created["ticks_100ns"] < review_created["ticks_100ns"]
        < go_created["ticks_100ns"]
        and authorization.get("schema_version") == 7
        and authorization.get("artifact_type")
        == "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDIT_AUTHORIZATION_V7"
        and authorization.get("status") == expected_base["authorization_status"]
        and authorization.get("audit_attempt_id") == FROZEN_V7_AUDIT_ATTEMPT_ID
        and authorization.get("recovery_attempt_id") == FROZEN_V7_RECOVERY_ATTEMPT_ID
        and authorization.get("runtime_identity_sha256") == V4_RUNTIME_IDENTITY_SHA256
        and authorization.get("independent_review_required") is True
        and authorization.get("independent_go_required") is True,
        "frozen V7 authorization header/chronology mismatch",
    )
    _v7_validate_policy(authorization, label="frozen V7 authorization")
    ...
    direct_path = path_under(root, RECOVERY_SEALER_ENTRYPOINT_INCIDENT_RELATIVE)
    direct_identity = identity(direct_path, root)
    direct_payload = _v5_load_strict_json(direct_path, label="frozen historical 9e74")
    historical_contract = _v6_validate_historical_9e74_payload(
        direct_payload, direct_identity
    )
    _v6_validate_historical_contract(
    ...
    _require(
        authorization.get("recovered_afterstate_commitment")
        == v5_base["commitment"] == V5_RECOVERED_AFTERSTATE_COMMITMENT,
        "frozen V7 recovered-afterstate commitment mismatch",
    )
    frozen_v6_actual: dict[str, dict[str, Any]] = {}
    frozen_v6_paths = {
        "superseded_v6_auditor": FROZEN_V6_AUDITOR,
    ...
    for role, expected in FROZEN_V6_SOURCE_IDENTITIES.items():
        _v4_require_exact_declared_identity(
            authorization.get(role), expected, label=f"frozen V7 {role}"
        )
        frozen_v6_actual[role] = _v4_verify_external_identity(
            authorization[role], frozen_v6_paths[role], label=f"frozen V7 {role}",
            expected_size_sha256=(int(expected["size_bytes"]), str(expected["sha256"])),
        )
    frozen_v7_paths = {
        "v7_auditor": FROZEN_V7_AUDITOR,
        "v7_auditor_test": FROZEN_V7_AUDITOR_TEST,
        "v7_sealer": FROZEN_V7_SEALER,
        "v7_sealer_test": FROZEN_V7_SEALER_TEST,
    }
    frozen_v7_actual: dict[str, dict[str, Any]] = {}
    for historical_role, expected in FROZEN_V7_SOURCE_IDENTITIES.items():
        role = historical_role.removeprefix("superseded_")
        _v4_require_exact_declared_identity(
            authorization.get(role), expected, label=f"frozen V7 {role}"
        )
        frozen_v7_actual[role] = _v4_verify_external_identity(
            authorization[role], frozen_v7_paths[role], label=f"frozen V7 {role}",
            expected_size_sha256=(int(expected["size_bytes"]), str(expected["sha256"])),
        )
    _v8_validate_frozen_v7_zero_snapshot(
        authorization.get("preaudit_zero_mutation_snapshot")
    )
    _require(
        authorization.get("required_command")
        == _v7_required_command(
            ROOT_DEFAULT,
            path_under(ROOT_DEFAULT, V7_AUTH_RELATIVE),
            path_under(ROOT_DEFAULT, V7_GO_RELATIVE),
        ),
        "frozen V7 required command mismatch",
    )
    evidence_bound = {
        "v5_authorization": FROZEN_V5_CONTROL_IDENTITIES["authorization"],
        "v5_independent_review": FROZEN_V5_CONTROL_IDENTITIES["independent_review"],
    ...
    _require(
        ...
        and review.get("artifact_type")
        == "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_REVIEW_V7"
        and review.get("status") == expected_base["review_status"]
        and review.get("verdict") == "GO_RECOMMENDED"
        and review.get("audit_attempt_id") == FROZEN_V7_AUDIT_ATTEMPT_ID
        and review.get("auditor_execution_started") is False
        and review.get("independent_go_required") is True
        and go.get("schema_version") == 7
        and go.get("artifact_type") == "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_GO_V7"
        and go.get("status") == expected_base["go_status"]
        and go.get("audit_attempt_id") == FROZEN_V7_AUDIT_ATTEMPT_ID
        and go.get("recovery_attempt_id") == FROZEN_V7_RECOVERY_ATTEMPT_ID
        and go.get("recovery_rerun_authorized") is False
        and go.get("required_command") == authorization.get("required_command"),
        "frozen V7 review/GO header mismatch",
    )
    _v7_validate_policy(review, label="frozen V7 review")
    _v7_validate_policy(go, label="frozen V7 GO")
    auth_identity = identity(paths["authorization"], root)
    review_identity = identity(paths["independent_review"], root)
    common_fields = (
        "incident", "v5_authority_base", "historical_failed_head_identity_contract",
        *FROZEN_V6_SOURCE_IDENTITIES.keys(), "v7_auditor", "v7_auditor_test",
        "v7_sealer", "v7_sealer_test", "recovered_afterstate_commitment",
    ...
    _require(
        review.get("authorization") == auth_identity
        and go.get("authorization") == auth_identity
        and go.get("independent_review") == review_identity
        and all(
            review.get(field) == authorization.get(field)
            and go.get(field) == authorization.get(field)
        ...
        "frozen V7 authorization/review/GO cross-binding mismatch",
    )
    checks = review.get("independent_checks")
    recheck = review.get("test_evidence_recheck")
    _require(
        ...
        "frozen V7 review checks/evidence recheck mismatch",
    )
    return {
        ...
        "review_created": review_created,
        "go": go,
        "go_identity": identity(paths["independent_go"], root),
        "go_created": go_created,
        "v5_base": v5_base,
        "recovered_afterstate": v5_base["recovered_afterstate"],
        "commitment": v5_base["commitment"],
        "timestamp_chain": timestamp_chain,
        "historical_contract": historical_contract,
        "timestamp_incident": timestamp_incident,
        "false_reject_incident": false_reject,
        "frozen_v7_source_identities": frozen_v7_actual,
    }


def _v8_validate_test_evidence(
    evidence: Any,
    *,
    authorization_created: Mapping[str, Any],
    bound_identities: Mapping[str, Mapping[str, Any]],
    ...
    expected_bound_keys = {
        "v7_authorization", "v7_independent_review", "v7_independent_go",
        "primary_duration_suffix_incident", "afterstate_commitment_correction",
        "immutable_v2_preflight", "superseded_v7_auditor",
        "superseded_v7_auditor_test", "superseded_v7_sealer",
        "superseded_v7_sealer_test", "v8_auditor", "v8_auditor_test",
        "v8_sealer", "v8_sealer_test",
    }
    _require(
        isinstance(evidence, Mapping)
        and set(evidence) == V8_TEST_EVIDENCE_KEYS
        and set(bound_identities) == expected_bound_keys,
        "V8 immutable test-evidence schema/bound-role mismatch",
    )
    created = _v7_parse_rfc3339_utc_100ns(
        evidence.get("created_utc"), label="V8 test evidence"
    )
    _require(
        evidence.get("schema_version") == 1
        and evidence.get("artifact_type")
        ...
        and evidence.get("pytest_isolation")
        == "ONE_TEST_FILE_PER_CLEAN_NETWORK_DENIED_SUBPROCESS"
        and evidence.get("required_test_names") == list(V8_REQUIRED_TEST_NAMES)
        and evidence.get("required_test_names_present") is True
        and evidence.get("all_exit_codes_zero") is True,
        "V8 immutable test-evidence header/binding mismatch",
    )
    _require(
        evidence.get("frozen_v7_preseal_test_evidence")
        == _v8_frozen_v7_preseal_test_evidence(v7_base),
    ...
    _require(
        ...
        and compile_record.get("files")
        == [
            bound_identities["v8_auditor"],
            bound_identities["v8_auditor_test"],
            bound_identities["v8_sealer"],
            bound_identities["v8_sealer_test"],
        ],
        "V8 exact-source compile evidence mismatch",
    )
    expected_commands = {
        "v8_auditor_tests": _v8_test_command(
            "tests/test_noaa_gfs_multiseason_raw_postrun_v8.py"
        ),
        "v8_sealer_tests": _v8_test_command(
            "tests/test_seal_noaa_gfs_multiseason_postrun_audit_v8.py"
        ),
        "frozen_v7_auditor_tests": _v8_test_command(
            "tests/test_noaa_gfs_multiseason_raw_postrun_v7.py"
        ),
        "frozen_v7_sealer_tests": _v8_test_command(
            "tests/test_seal_noaa_gfs_multiseason_postrun_audit_v7.py"
        ),
    }
    runs = evidence.get("test_runs")
    _require(
        isinstance(runs, Mapping) and set(runs) == V8_TEST_RUN_KEYS,
        "V8 immutable pytest run map mismatch",
    )
    for role, expected_command in expected_commands.items():
        run = runs[role]
        _require(
            isinstance(run, Mapping)
            and set(run) == V8_TEST_RUN_RECORD_KEYS
            and run.get("command") == expected_command
            and run.get("exit_code") == 0
            and isinstance(run.get("summary"), str)
            and "passed" in str(run["summary"])
            ...
            and run.get("network_guard_installed") is True
            and run.get("cacheprovider_disabled") is True,
            f"V8 immutable pytest run mismatch: {role}",
        )
        expected_deselect = [
        ...
        _require(
            run.get("selection_mode")
            == (
                "FULL_FILE_MINUS_EXACT_OBSOLETE_PRESEAL_STATE_TESTS"
                if expected_deselect else "FULL_FILE"
            )
            and run.get("deselected_nodeids") == expected_deselect
            and run.get("deselected_count") == len(expected_deselect),
            f"V8 immutable pytest selection record mismatch: {role}",
        )
        _v8_validate_bound_test_run_summary(role, run["summary"])
    production = evidence.get("production_shape_regression")
    _require(
        isinstance(production, Mapping)
        and set(production) == V8_PRODUCTION_SHAPE_KEYS
        and all(production.get(key) is True for key in V8_PRODUCTION_SHAPE_KEYS)
        and evidence.get("real_seven_spawn_regression")
        == {
            "start_method": "spawn",
        ...
        and evidence.get("models_fit") == 0
        and evidence.get("submission_csv_created") is False,
        "V8 immutable test-evidence safety/regression mismatch",
    )
    return created


def _v8_validate_predata_authority(
    root: Path, authorization_path: Path, go_path: Path
) -> dict[str, Any]:
    """Close V8 authority and immutable V2 evidence before any data route."""

    expected_authorization_path = path_under(root, V8_AUTH_RELATIVE)
    expected_review_path = path_under(root, V8_REVIEW_RELATIVE)
    expected_go_path = path_under(root, V8_GO_RELATIVE)
    _require(
        Path(os.path.abspath(authorization_path)) == expected_authorization_path
        and Path(os.path.abspath(go_path)) == expected_go_path,
        "V8 authorization/GO paths are not canonical",
    )
    for path, label in (
        (expected_authorization_path, "V8 authorization"),
        (expected_review_path, "V8 independent review"),
        (expected_go_path, "V8 independent GO"),
    ):
        require_no_symlink_chain(path, root, label=label)
        _require(
            os.path.lexists(str(path)) and path.is_file() and not _linklike(path),
    ...
    _require(
        expected_authorization_path.stat().st_size <= 32_768
        and expected_review_path.stat().st_size <= 12_000
        and expected_go_path.stat().st_size <= 12_000,
        "V8 compact control exceeds its transport cap",
    )
    namespace_start = _v8_validate_control_namespace(root)
    _require(_v8_control_temporary_files(root) == [], "V8 control temporary files present")
    _require(
        _v8_postrun_report_candidates(root) == [],
        "persisted V2/V3/V4/V5/V6/V7/V8 postrun report candidate is forbidden",
    )
    authorization = _v5_load_strict_json(
        expected_authorization_path, label="V8 authorization"
    )
    review = _v5_load_strict_json(expected_review_path, label="V8 independent review")
    go = _v5_load_strict_json(expected_go_path, label="V8 independent GO")
    _require(set(authorization) == V8_AUTH_KEYS, "V8 authorization schema mismatch")
    _require(set(review) == V8_REVIEW_KEYS, "V8 independent review schema mismatch")
    _require(set(go) == V8_GO_KEYS, "V8 independent GO schema mismatch")
    for payload, label in (
        (authorization, "V8 authorization"),
        (review, "V8 independent review"),
        (go, "V8 independent GO"),
    ):
        _v8_assert_compact_control(payload, label=label)
    authorization_created = _v7_parse_rfc3339_utc_100ns(
        authorization.get("created_utc"), label="V8 authorization"
    )
    review_created = _v7_parse_rfc3339_utc_100ns(
        review.get("created_utc"), label="V8 review"
    )
    go_created = _v7_parse_rfc3339_utc_100ns(go.get("created_utc"), label="V8 GO")
    attempt_id = authorization.get("audit_attempt_id")
    derived_attempt = "postrun_audit_v8__" + str(authorization["created_utc"]).translate(
        str.maketrans("", "", "-:.")
    )
    _require(
        ...
        and isinstance(attempt_id, str)
        and re.fullmatch(r"postrun_audit_v8__[0-9]{8}T[0-9]{12}Z", attempt_id)
        is not None
        and attempt_id == derived_attempt
        and authorization.get("recovery_attempt_id") == FROZEN_V7_RECOVERY_ATTEMPT_ID
        and authorization.get("runtime_identity_sha256") == V4_RUNTIME_IDENTITY_SHA256
        and authorization.get("independent_review_required") is True
        and authorization.get("independent_go_required") is True,
        "V8 authorization header/binding mismatch",
    )
    _v8_validate_policy(authorization, label="V8 authorization")

    v7_base = _v8_load_and_validate_v7_authority_base(
        root, authorization.get("v7_authority_base")
    )
    failure_chain = _v8_validate_duration_suffix_incident_chain(
        root,
        authorization.get("v7_live_failure_state", {}).get("primary_incident")
        if isinstance(authorization.get("v7_live_failure_state"), Mapping)
        else None,
        authorization.get("v7_live_failure_state", {}).get("correction_record")
        if isinstance(authorization.get("v7_live_failure_state"), Mapping)
        else None,
    )
    _require(
        authorization.get("v7_live_failure_state") == failure_chain["state"],
        "V8 live-failure state summary mismatch",
    )
    preflight = _v8_validate_actual_v2_preflight_evidence(root)
    _require(
        authorization.get("immutable_v2_preflight_evidence")
        == preflight["commitment"],
        "V8 immutable V2 preflight commitment mismatch",
    )
    _require(
        authorization.get("recovered_afterstate_commitment")
        == v7_base["commitment"] == V5_RECOVERED_AFTERSTATE_COMMITMENT,
        "V8 recovered-afterstate commitment mismatch",
    )
    frozen_v7_actual: dict[str, dict[str, Any]] = {}
    frozen_v7_paths = {
        "superseded_v7_auditor": FROZEN_V7_AUDITOR,
        "superseded_v7_auditor_test": FROZEN_V7_AUDITOR_TEST,
        "superseded_v7_sealer": FROZEN_V7_SEALER,
        "superseded_v7_sealer_test": FROZEN_V7_SEALER_TEST,
    }
    for role, expected in FROZEN_V7_SOURCE_IDENTITIES.items():
        _v4_require_exact_declared_identity(
            authorization.get(role), expected, label=f"V8 {role}"
        )
        frozen_v7_actual[role] = _v4_verify_external_identity(
            authorization[role], frozen_v7_paths[role], label=f"V8 {role}",
            expected_size_sha256=(int(expected["size_bytes"]), str(expected["sha256"])),
        )
    v8_paths = {
        "v8_auditor": Path(__file__).resolve(),
        "v8_auditor_test": AUDITOR_TEST,
        "v8_sealer": V8_SEALER,
        "v8_sealer_test": V8_SEALER_TEST,
    }
    v8_actual = {
        role: _v4_verify_external_identity(
            authorization.get(role), path, label=f"V8 executing {role}"
        )
        for role, path in v8_paths.items()
    }
    _v8_validate_zero_snapshot(
        root,
        authorization.get("preaudit_zero_mutation_snapshot"),
        failure_state=failure_chain["state"],
    )
    _require(
        authorization.get("required_command")
        == _v8_required_command(root, expected_authorization_path, expected_go_path),
        "V8 authorization required command mismatch",
    )
    evidence_bound = {
        "v7_authorization": FROZEN_V7_CONTROL_IDENTITIES["authorization"],
        "v7_independent_review": FROZEN_V7_CONTROL_IDENTITIES["independent_review"],
        "v7_independent_go": FROZEN_V7_CONTROL_IDENTITIES["independent_go"],
        "primary_duration_suffix_incident": failure_chain["primary_identity"],
        "afterstate_commitment_correction": failure_chain["correction_identity"],
        "immutable_v2_preflight": preflight["preflight_identity"],
        **frozen_v7_actual,
        **v8_actual,
    }
    evidence_created = _v8_validate_test_evidence(
        authorization.get("test_evidence"),
        authorization_created=authorization_created,
        bound_identities=evidence_bound,
        v7_base=v7_base,
    ...
    _require(
        v7_base["go_created"]["ticks_100ns"]
        < failure_chain["primary_created"]["ticks_100ns"]
        < failure_chain["correction_created"]["ticks_100ns"]
        <= evidence_created["ticks_100ns"]
        <= authorization_created["ticks_100ns"]
        < review_created["ticks_100ns"]
        < go_created["ticks_100ns"],
        "V8 V7-base/failure/evidence/control chronology mismatch",
    )
    _require(
        review.get("schema_version") == 8
        and review.get("artifact_type")
        == "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_REVIEW_V8"
        and review.get("status") == "PASS_PENDING_INDEPENDENT_GO_V8"
        and review.get("verdict") == "GO_RECOMMENDED"
        and review.get("audit_attempt_id") == attempt_id
        and review.get("auditor_execution_started") is False
        and review.get("independent_go_required") is True
        and go.get("schema_version") == 8
        and go.get("artifact_type") == "TRACK_A_DECODE_RECOVERY_POSTRUN_AUDITOR_GO_V8"
        and go.get("status") == "GO_V8_READ_ONLY_NETWORK_ZERO_FULL_OFFLINE_REPLAY"
        and go.get("audit_attempt_id") == attempt_id
        and go.get("recovery_attempt_id") == FROZEN_V7_RECOVERY_ATTEMPT_ID
        and go.get("recovery_rerun_authorized") is False
        and go.get("required_command") == authorization.get("required_command"),
        "V8 independent review/GO header mismatch",
    )
    _v8_validate_policy(review, label="V8 independent review")
    _v8_validate_policy(go, label="V8 independent GO")
    authorization_actual = identity(expected_authorization_path, root)
    review_actual = identity(expected_review_path, root)
    common_fields = (
        "v7_authority_base", "v7_live_failure_state",
        "immutable_v2_preflight_evidence", *FROZEN_V7_SOURCE_IDENTITIES.keys(),
    ...
    _require(
        ...
        "V8 authorization/review/GO cross-binding mismatch",
    )
    checks = review.get("independent_checks")
    recheck = review.get("test_evidence_recheck")
    _require(
        isinstance(checks, Mapping)
        and set(checks) == V8_REVIEW_CHECKS
        and all(checks.get(key) is True for key in V8_REVIEW_CHECKS),
        "V8 independent review check set/verdict mismatch",
    )
    _require(
        isinstance(recheck, Mapping)
        and set(recheck) == V4_REVIEW_TEST_RECHECK_KEYS
        ...
        "V8 independent test-evidence recheck mismatch",
    )
    _require(
        _v8_validate_control_namespace(root) == namespace_start
        and _v8_control_temporary_files(root) == []
        and _v8_postrun_report_candidates(root) == [],
        "V8 predata control namespace changed",
    )
    return {
        "authorization": authorization,
        "authorization_identity": authorization_actual,
        ...
        "immutable_v2_preflight": preflight,
        "recovered_afterstate": v7_base["recovered_afterstate"],
        "recovered_afterstate_commitment": v7_base["commitment"],
        "frozen_v7_source_identities": frozen_v7_actual,
        "v8_source_identities": v8_actual,
        "control_namespace": namespace_start,
    }


def _v8_validate_postauthority_control_state(
    root: Path, authority: Mapping[str, Any]
) -> dict[str, Any]:
    authorization = authority["authorization"]
    afterstate = authority["recovered_afterstate"]
    _require(
        not os.path.lexists(str(path_under(root, "raw/RAW_LAUNCH_ACTIVE.lock")))
        and not os.path.lexists(str(path_under(root, "decoded/DECODE_RECOVERY_ACTIVE.lock"))),
        "V8 recovered afterstate has an active lock",
    )
    commitment = _v5_recovered_afterstate_commitment(afterstate)
    _require(
        commitment == authority["recovered_afterstate_commitment"]
        and _v8_control_temporary_files(root) == []
        and _v8_postrun_report_candidates(root) == [],
        "V8 afterstate/commitment/temp/report recheck mismatch",
    )
    v7_base = _v8_load_and_validate_v7_authority_base(
        root, authorization["v7_authority_base"]
    )
    _require(
        v7_base["summary"] == authority["v7_base"]["summary"]
        and v7_base["recovered_afterstate"] == afterstate
        and v7_base["commitment"] == commitment,
        "V8 frozen V7 authority base changed during audit",
    )
    failure_chain = _v8_validate_duration_suffix_incident_chain(
        root,
        authorization["v7_live_failure_state"]["primary_incident"],
        authorization["v7_live_failure_state"]["correction_record"],
    )
    _require(
        failure_chain["state"] == authority["failure_chain"]["state"]
        == authorization["v7_live_failure_state"],
        "V8 dual incident/correction chain changed during audit",
    )
    preflight = _v8_validate_actual_v2_preflight_evidence(root)
    _require(
        preflight["commitment"]
        == authority["immutable_v2_preflight"]["commitment"]
        == authorization["immutable_v2_preflight_evidence"]
        and preflight["preflight_identity"]
        == authority["immutable_v2_preflight"]["preflight_identity"],
        "V8 immutable V2 preflight evidence changed during audit",
    )
    _require(
        _v8_validate_control_namespace(root) == authority["control_namespace"],
        "V8 control namespace changed during audit",
    )
    for role, record, relative in (
        ("authorization", authority["authorization_identity"], V8_AUTH_RELATIVE),
        ("independent review", authority["review_identity"], V8_REVIEW_RELATIVE),
        ("independent GO", authority["go_identity"], V8_GO_RELATIVE),
    ):
        verify_identity(
            record, path_under(root, relative), root=root,
            label=f"V8 postauthority {role}",
        )
    for role, expected in FROZEN_V7_SOURCE_IDENTITIES.items():
        path = {
            "superseded_v7_auditor": FROZEN_V7_AUDITOR,
        ...
        _v4_verify_external_identity(
            authorization[role], path, label=f"V8 postauthority {role}",
            expected_size_sha256=(int(expected["size_bytes"]), str(expected["sha256"])),
        )
    for role, path in {
        "v8_auditor": Path(__file__).resolve(),
    ...
    _v8_validate_zero_snapshot(
        root,
        authorization["preaudit_zero_mutation_snapshot"],
        failure_state=failure_chain["state"],
    )
    return commitment


def _v8_validate_postauthority_afterstate(
    root: Path, authority: Mapping[str, Any]
) -> dict[str, Any]:
    v4_authorization = authority["v7_base"]["v5_base"]["v4_base"]["authorization"]
    commitment = _v8_validate_postauthority_control_state(root, authority)
    for role, record in v4_authorization["canonical_outputs"].items():
        verify_identity(
            record, path_under(root, str(record["path"])), root=root,
            label=f"V8 inherited canonical output {role}",
        )
    for role, record in v4_authorization["recovery_transaction"].items():
        verify_identity(
            record, path_under(root, str(record["path"])), root=root,
            label=f"V8 inherited recovery transaction {role}",
        )
    history = v4_authorization["recovery_history"]
    for role, record in history["completion_locks"].items():
        verify_identity(
            record, path_under(root, str(record["path"])), root=root,
            label=f"V8 inherited recovery completion lock {role}",
        )
    verify_identity(
        history["postcommit_input_audit"],
        path_under(root, str(history["postcommit_input_audit"]["path"])),
        root=root, label="V8 inherited recovery postcommit input audit",
    )
    history_dir = path_under(root, "decoded/recovery_history")
    expected_history_paths = {
        str(record["path"]) for record in history["completion_locks"].values()
    ...
    _require(
        ...
        and {path.relative_to(root).as_posix() for path in actual_history_entries}
        == expected_history_paths,
        "V8 recovery-history exact filesystem closure mismatch",
    )
    transaction_root = path_under(root, "raw/output_transactions")
    _require(
        transaction_root.is_dir() and not _linklike(transaction_root),
        "V8 output-transaction root invalid",
    )
    recovery_authorization_v2 = _v5_load_strict_json(
        path_under(root, V4_V2_CONTROL_RELATIVES["recovery_authorization_v2"]),
        label="V8 recovery authorization V2 closure",
    )
    remnants = recovery_authorization_v2.get("documented_preplan_remnants")
    _require(
        isinstance(remnants, list) and len(remnants) == 2,
        "V8 incident-bound preplan-remnant declaration mismatch",
    )
    expected_transaction_files = {
        str(v4_authorization["recovery_transaction"]["plan"]["path"]),
        str(v4_authorization["recovery_transaction"]["commit"]["path"]),
    ...
    for index, record in enumerate(remnants):
        _require(
            isinstance(record, Mapping) and set(record) == {"path", "size_bytes", "sha256"},
            f"V8 preplan remnant identity invalid: {index}",
        )
        verify_identity(
            record, path_under(root, str(record["path"])), root=root,
            label=f"V8 incident-bound preplan remnant {index}",
        )
        expected_transaction_files.add(str(record["path"]))
    expected_transaction_dirs = {
        "raw/output_transactions/20260810T151057590738Z__pid3536__5f3e0fb20132",
    ...
    actual_transaction_dirs: set[str] = set()
    for path in transaction_root.rglob("*"):
        _require(not _linklike(path), "V8 transaction tree contains a link/junction")
        relative = path.relative_to(root).as_posix()
        if path.is_file():
            actual_transaction_files.add(relative)
        elif path.is_dir():
            ...
            raise AuditFailure("V8 transaction tree contains a special object")
    _require(
        actual_transaction_files == expected_transaction_files
        and actual_transaction_dirs == expected_transaction_dirs
        and len(actual_transaction_files) == 4,
        "V8 transaction recursive exact filesystem closure mismatch",
    )
    progress_dir = path_under(root, "decoded/recovery_progress")
    actual_progress_paths = sorted(progress_dir.iterdir(), key=lambda path: path.name)
    _require(
        ...
        and len(actual_progress_paths) == 104
        and all(path.is_file() and not _linklike(path) for path in actual_progress_paths),
        "V8 recovery-progress filesystem closure mismatch",
    )
    actual_inventory = [identity(path, root) for path in actual_progress_paths]
    inventory_bytes = _v4_canonical_bytes(actual_inventory)
    _require(
        ...
        and hashlib.sha256(inventory_bytes).hexdigest()
        == V4_PROGRESS_INVENTORY_CANONICAL_SHA256,
        "V8 recovery-progress inventory/canonical digest mismatch",
    )
    _require(
        _v8_validate_postauthority_control_state(root, authority) == commitment,
        "V8 postauthority compact control state changed",
    )
    return {
        "recovered_afterstate_commitment": commitment,
        "recovered_afterstate_canonical_sha256": V4_RECOVERED_AFTERSTATE_CANONICAL_SHA256,
        ...
        "recovery_progress_file_count": 104,
        "active_locks_present": 0,
        "v8_control_temporary_files_present": 0,
        "canonical_v4_go_present": 0,
        "v7_authority_base_rehashed": True,
        "dual_failure_incident_chain_rehashed": True,
        "immutable_v2_preflight_revalidated": True,
        "control_namespace_exact": True,
    }
...
def audit(
    ...
    *,
    ...
    if contract == PRODUCTION_CONTRACT:
        _require(
            _V8_CANONICAL_MAIN_ACTIVE,
            "V8 production audit is callable only from the canonical guarded main",
        )
    authority: dict[str, Any] | None = None
    v8_afterstate_start: dict[str, Any] | None = None
    v8_afterstate_end: dict[str, Any] | None = None
    if contract == PRODUCTION_CONTRACT or authorization_path is not None or independent_go_path is not None:
        _require(
            ...
            "V8 production audit requires authorization and independent GO",
        )
        authority = _v8_validate_predata_authority(
            root, authorization_path.resolve(), independent_go_path.resolve()
        )
        v8_afterstate_start = _v8_validate_postauthority_afterstate(root, authority)
    ...
    if authority is not None:
        v8_afterstate_end = _v8_validate_postauthority_afterstate(root, authority)
        _require(
            v8_afterstate_end == v8_afterstate_start,
            "V8 recovered afterstate commitment changed during full audit",
        )
    return {
        "artifact_type": "TRACK_A_RAW_PRODUCER_POSTRUN_READONLY_AUDIT_V8",
        "schema_version": 8,
        "status": "PASS_PRODUCER_POSTRUN_READONLY_AUDIT_V8",
        ...
        "provenance": {
            ...
            "executing_v8_auditor": (
                authority["v8_source_identities"]["v8_auditor"]
                if authority is not None
                else identity(Path(__file__).resolve())
            ),
            "executing_v8_auditor_test": (
                authority["v8_source_identities"]["v8_auditor_test"]
                if authority is not None
                else identity(AUDITOR_TEST)
            ),
            "executing_v8_sealer": (
                authority["v8_source_identities"]["v8_sealer"]
                if authority is not None else None
            ),
            "executing_v8_sealer_test": (
                authority["v8_source_identities"]["v8_sealer_test"]
                if authority is not None else None
            ),
            ...
            "frozen_v7_source_baseline": (
                authority["frozen_v7_source_identities"]
                if authority is not None else FROZEN_V7_SOURCE_IDENTITIES
            ),
            "v8_audit_authorization": (
            ...
            "v7_authority_base": (
                authority["v7_base"]["summary"] if authority is not None else None
            ),
            "v7_duration_suffix_false_reject_incident": (
                authority["failure_chain"]["primary_identity"]
                if authority is not None else None
            ),
            "v7_duration_suffix_afterstate_correction": (
                authority["failure_chain"]["correction_identity"]
                if authority is not None else None
            ),
        ...
        "audit_models_fit": 0,
        "audit_files_written": 0,
        "v8_authorized_afterstate_recheck": {
            "start": v8_afterstate_start,
            "end": v8_afterstate_end,
        },
    }
...
def main(argv: Sequence[str] | None = None) -> int:
    global _V8_CANONICAL_MAIN_ACTIVE
    args = parse_args(argv)
    root = args.root.resolve()
    try:
        _require(
            args.authorization is not None and args.independent_go is not None,
            "V8 canonical command requires explicit --authorization and --independent-go",
        )
        authorization_path = args.authorization.resolve()
        independent_go_path = args.independent_go.resolve()
        _v8_require_canonical_runtime_entrypoint(
            root, authorization_path, independent_go_path
        )
        _V8_CANONICAL_MAIN_ACTIVE = True
        report = audit(
            root,
            ...
            json.dumps(
                {
                    "artifact_type": "TRACK_A_RAW_PRODUCER_POSTRUN_READONLY_AUDIT_V8",
                    "schema_version": 8,
                    "status": "CONDITIONAL_SKIP_V8_POSTRUN_AUDIT_ACTIVE",
                    "reason": str(exc),
            ...
            json.dumps(
                {
                    "artifact_type": "TRACK_A_RAW_PRODUCER_POSTRUN_READONLY_AUDIT_V8",
                    "schema_version": 8,
                    "status": "FAIL_PRODUCER_POSTRUN_AUDIT_V8",
                    "reason": str(exc),
                    "audit_network_requests": 0,
                    "audit_files_written": 0,
                },
