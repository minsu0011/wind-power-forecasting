#!/usr/bin/env python
"""Offline, read-only V2 postrun audit for the frozen Track A raw producer.
...
AUDITOR_TEST = REPO / "tests" / "test_noaa_gfs_multiseason_raw_postrun_v2.py"
...
def audit(
    ...
    *,
    ...
    return {
        "artifact_type": "TRACK_A_RAW_PRODUCER_POSTRUN_READONLY_AUDIT_V2",
        "schema_version": 2,
        "status": "PASS_PRODUCER_POSTRUN_READONLY_AUDIT_V2",
